...
const matches = [
  ...
  {
    title: MatchType7,
    link: `/matches/?type=${MatchType7}`,
    image: MatchType7Img,
  },
  {
    title: MatchType8,
    link: `/matches/?type=${MatchType8}`,
    image: MatchType8Img,
  },
  {
    title: MatchType9,
    link: `/matches/?type=${MatchType9}`,
    image: MatchType9Img,
  },
  {
    title: MatchType10,
    link: `/matches/?type=${MatchType10}`,
      ...
      <div className="grid grid-cols-2 gap-4">
        {matches.map((match, index) => (
          ...
          >
            ...
            <CardContent>
              <CardTitle className="text-sm font-bold">{match.title}</CardTitle>
